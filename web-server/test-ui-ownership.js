...
/* The trailing Branch action has no adjacent toolbar control to separate. */
#desktop-app-toolbar > .toolbar-action-menu:last-child > .toolbar-button > button {
  border-right: 0;
}
...
:root {
  ...
  /* Keep the shared desktop spacing rhythm with compact controls. */
  --spacing: 10px;
  --button-height: 32px;
  --text-field-height: 32px;
  --dropdown-select-button-height: 34px;
